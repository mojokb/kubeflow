...
export class ResourceTableComponent implements OnInit {
  ...
  // Resource (Vscode) Actions
  connectResource(rsrc: Resource): void {
    window.open(`/vscode/${rsrc.namespace}/${rsrc.name}/`);
  }
  ...
  deleteResource(rsrc: Resource): void {
    const dialogRef = this.dialog.open(ConfirmDialogComponent, {
      width: "fit-content",
      data: {
        title: "You are about to delete Vscode Server: " + rsrc.name,
        message:
          "Are you sure you want to delete this Vscode Server? " +
