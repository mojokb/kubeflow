...
import { RokCodeserverLabSelectorComponent } from "./uis/rok/rok-resource-form/rok-codeserver-lab-selector/rok-codeserver-lab-selector.component";
...
@NgModule({
  declarations: [
    ...
    RokCodeserverLabSelectorComponent,
    RokVolumeComponent,
