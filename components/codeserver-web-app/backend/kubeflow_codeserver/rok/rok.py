...
def attach_rok_token_secret(vscode):
    ...
    vscode["spec"]["template"]["spec"]["containers"][0]["env"] += [
        {
            "name": "ROK_GW_TOKEN",
